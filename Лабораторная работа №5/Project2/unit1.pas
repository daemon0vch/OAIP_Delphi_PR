...
begin
  ...
  begin
       if bodyWeightIndex <= 25.9999999999999 then bodyWeightIndexMessage.Caption:='Идеально';
  end;
  if bodyWeightIndex >= 26 then
  Begin
      if bodyWeightIndex <=30.9999999999999 then bodyWeightIndexMessage.Caption:='Легкий перебор';
  end;
